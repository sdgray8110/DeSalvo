...
////////////////////////////////////////////////////////////
$alt = 'DeSalvo Custom Cycles | Steel Track Bikes';
$pageName = 'steelTrack';
...
include("php/pagetitles/steel_track.php");
...
include("php/descriptions/steetrack_description.php");
include("php/features/steeltrack_features.php");
include("php/tubing/steeltrack_tubing.php");
include("php/faq.php");
include("php/geometry/steeltrack_geometry.php");

...
<div class="updates">
    ...
    <div class="facebook">
		<div class="facebookcontent">
            ...
            <div class="fbright">
                <a class="thumb" rel="superbox[image]" href="<?php $feed->get_original_picture(7, true); ?>"><?php $feed->get_thumbnail(7); ?></a>
                <h5><?php $feed->get_date(7);?> | <a href="<?php $feed->get_link(7);?>"><?php $feed->get_likes(7);?></a></h5>
                <p><?php $feed->get_message(7);?></p>
            </div>
		</div>
	</div>
</div>
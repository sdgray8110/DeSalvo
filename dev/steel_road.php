...
////////////////////////////////////////////////////////////
$alt = 'DeSalvo Custom Cycles | Steel Road Bikes';
$pageName = 'steelRoad';
...
include("php/pagetitles/steel_road.php");
...
include("php/descriptions/steelroad.php");
include("php/features/steelroad_features.php");
include("php/tubing/steelroadtubing.php");
include("php/faq.php");
include("php/geometry/tradroad.php");
